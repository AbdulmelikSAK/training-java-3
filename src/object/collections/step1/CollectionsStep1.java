...
public class CollectionsStep1 {
  ...
  static int[] identify(Object array[]) {
    ...
    for (int i = 0; i < array.length; i++) {
      Object o = array[i];
      if (instanceOf("object.collections.step1.Point", o)) { 
        kinds[i] = POINT;
      } else if (instanceOf("object.collections.step1.Line", o)) {
        kinds[i] = LINE;
      } else if (instanceOf("object.collections.step1.Rectangle", o)) {
        kinds[i] = RECTANGLE;
      } else
        kinds[i] = UNKNOWN;
    }
  ...
  static int[] identify2(Object array[]) {
	    int[] kinds = new int[array.length];
	    for (int i = 0; i < array.length; i++) {
	      Object o = array[i];
	      try {
  ...
  static int[] identify3(Object array[]) {
	    int[] kinds = new int[array.length];
	    for (int i = 0; i < array.length; i++) {
	      Object o = array[i];
